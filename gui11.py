...
class HeadChefAdvancedMenu(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        self.button_image_1 = PhotoImage(file=r"assets\frame11\button_9.png")
        button_1 = Button(
            canvas,
            image=self.button_image_1,
            borderwidth=0,
            highlightthickness=0,
            command=lambda: controller.show_current_frame(NewOrder),
            relief="flat"
        )
        button_1.place(
            x=30.0,
        ...
        button_3 = Button(
            ...
            borderwidth=0,
            highlightthickness=0,
            command=lambda: controller.show_current_frame(NewProducts),
            relief="flat"
        )
        button_3.place(
            x=185.0,
        ...
        button_4 = Button(
            ...
            borderwidth=0,
            highlightthickness=0,
            command=lambda: controller.show_current_frame(NewSupplier),
            relief="flat"
        )
        button_4.place(
            x=30.0,
